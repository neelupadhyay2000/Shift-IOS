...
public final class ShiftUndoManager {
    ...
    /// Records a new undoable operation.
    ///
    /// Call this **after** ``RippleEngine/recalculate`` has mutated the blocks,
    /// passing the snapshots you captured before and after the call.
    ///
    /// - Parameters:
