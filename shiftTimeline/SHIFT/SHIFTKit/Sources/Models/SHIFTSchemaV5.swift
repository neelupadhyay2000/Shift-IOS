...
/// types here (rather than reusing V4's) is what gives V5 a distinct
/// checksum so `MigrationStage.lightweight(V4 → V5)` can run.
public enum SHIFTSchemaV5: VersionedSchema {
    ...
    public final class TimeBlockModel {
        ...
        /// New in V5. Marks blocks auto-inserted as transit/driving blocks
        /// between two venues so they're excluded from venue-switch detection.
