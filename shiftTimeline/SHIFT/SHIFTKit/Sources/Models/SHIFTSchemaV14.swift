...
/// V14 schema — adds `updatedAt` (`Date?`) to `EventModel`, `TimelineTrack`,
...
/// unchanged. Adding optional properties (default `nil`) is a lightweight
/// migration.
public enum SHIFTSchemaV14: VersionedSchema {
    public static var versionIdentifier: Schema.Version { Schema.Version(14, 0, 0) }

    public static var models: [any PersistentModel.Type] {
        [
            SHIFTSchemaV14.EventModel.self,
            SHIFTSchemaV14.TimeBlockModel.self,
            SHIFTSchemaV14.TimelineTrack.self,
            SHIFTSchemaV14.VendorModel.self,
            SHIFTSchemaV14.ShiftRecord.self,
            SHIFTSchemaV14.OutboxEntry.self,
        ]
    }
