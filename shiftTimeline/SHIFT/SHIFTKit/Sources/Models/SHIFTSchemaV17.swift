...
/// V17 schema — adds `VendorModel.customRoleLabel` (`String`, default `""`),
/// the user-entered vendor type shown when `role == .custom` (SHIFT custom
/// vendor types). Adding a defaulted property is a lightweight migration.
/// All other models are unchanged from V16.
public enum SHIFTSchemaV17: VersionedSchema {
    public static var versionIdentifier: Schema.Version { Schema.Version(17, 0, 0) }

    public static var models: [any PersistentModel.Type] {
        [
            SHIFTSchemaV17.EventModel.self,
            SHIFTSchemaV17.TimeBlockModel.self,
            SHIFTSchemaV17.TimelineTrack.self,
            SHIFTSchemaV17.VendorModel.self,
            SHIFTSchemaV17.ShiftRecord.self,
            SHIFTSchemaV17.OutboxEntry.self,
        ]
    }
