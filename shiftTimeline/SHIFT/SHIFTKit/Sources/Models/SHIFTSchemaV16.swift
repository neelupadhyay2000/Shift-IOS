...
public enum SHIFTSchemaV16: VersionedSchema {
    public static var versionIdentifier: Schema.Version { Schema.Version(16, 0, 0) }

    public static var models: [any PersistentModel.Type] {
        [
            SHIFTSchemaV16.EventModel.self,
            SHIFTSchemaV16.TimeBlockModel.self,
            SHIFTSchemaV16.TimelineTrack.self,
            SHIFTSchemaV16.VendorModel.self,
            SHIFTSchemaV16.ShiftRecord.self,
            SHIFTSchemaV16.OutboxEntry.self,
        ]
    }
